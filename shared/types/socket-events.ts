...
export interface ClientToServerEvents {
  ...
  getPublicRooms: (data?: { gameType?: string }) => void;
  ...
  autoUpdateRoomStatus: (data: { roomCode: string }) => void;
...
export interface ServerToClientEvents {
  ...
  publicRoomsList: (data: { rooms: Room[] }) => void;
  ...
  'friend:list-online': (data: { onlineUserIds: string[] }) => void;

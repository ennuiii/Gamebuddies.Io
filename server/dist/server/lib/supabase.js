...
exports.db = exports.DatabaseService = exports.supabaseAdmin = exports.supabase = void 0;
...
class DatabaseService {
    ...
    isSupabase;
    constructor() {
        this.client = exports.supabase;
        this.adminClient = exports.supabaseAdmin;
    ...
    async cleanupInactiveRooms(options = {}) {
        try {
            const { maxAgeHours = 24, // Rooms older than 24 hours
    ...
    async getRoomStats() {
        try {
            ...
            stats?.forEach((room) => {
                ...
                if (roomAge < oneHourAgo)
                    summary.byAge.lastHour++;
                else if (roomAge < oneDayAgo)
                    summary.byAge.lastDay++;
                else if (roomAge < oneWeekAgo)
                    summary.byAge.lastWeek++;
                else
                    summary.byAge.older++;
                // Count by activity
                ...
                if (idleTime < (10 * 60 * 1000))
                    ...
                    summary.byActivity.stale++; // Stale for more than 1 hour
            });
            return summary;
        }
        catch (error) {
